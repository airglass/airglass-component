...
export default class Renderer extends Glass {
  ...
  setInteractable() {
    ...
    canvas.addEventListener('touchstart', this._eventListener);
    canvas.addEventListener('mousemove', this._eventListener);
    canvas.addEventListener('touchmove', this._eventListener);
    canvas.addEventListener('mouseup', this._eventListener);
    canvas.addEventListener('touchend', this._eventListener);
    return this;
  }
  offInteractable() {
    let canvas: HTMLCanvasElement = this.ctx.canvas;
    canvas.removeEventListener('mousedown', this._eventListener);
    canvas.removeEventListener('touchstart', this._eventListener);
    canvas.removeEventListener('mousemove', this._eventListener);
    canvas.removeEventListener('touchmove', this._eventListener);
    canvas.removeEventListener('mouseup', this._eventListener);
    canvas.removeEventListener('touchend', this._eventListener);
    return this;
  }
  clean() {
